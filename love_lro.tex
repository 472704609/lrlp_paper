...
Of particular interest is the case when the nominal distribution is determined by observation, i.e., making it an empirical distribution.
...
We examine the properties of the resulting model, provide a classification of $\phi$-divergences and insight about the use of each class, and develop a simple condition for assessing the value of collecting extra data.
