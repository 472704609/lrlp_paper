...
Recall the primal-dual variable relation, which specifies $\frac{p_\omega}{q_\omega} = \partial \phi^*(s_\omega)$, where $s_\omega$ is defined in (\ref{eq:s_omega_definition}).
...
{\begin{tabular}{l}
	...
	\textbf{While} $z_u - z_l \geq \texttt{TOL}\min\{|z_u|,|z_l|\}$ \textbf{do} \\
