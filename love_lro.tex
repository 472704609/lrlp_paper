...
Several distributionally robust studied have used chance constrained stochastic problems.
\cite{erdogan2006ambiguous} study the case where the set of distributions considered is determined by the Prohorov metric.
...
\cite{jiang2012data} develop an exact approach to solving several classes of data-driven chance constrained programs, including one defined by the Kullback-Leibler divergence.
...
The proof of Property \ref{property:coherent_risk_measure} is given in the appendix.
