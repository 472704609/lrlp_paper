...
\KEYWORDS{Ambiguous stochastic programming, distributionally robust optimization, phi-divergences}
...
This divergence is included because \cite{calafiore2007ambiguous}, \cite{hukullback}, and \cite{wang2010likelihood} all use it to formulate distributionally robust programs.
