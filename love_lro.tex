...
\begin{abstract}
	We adapt the $\phi$-divergence constrained method of distributionally robust optimization recently proposed by Ben-Tal et.\ al.\ to a two-stage setting.
...
Two recent papers by Wang, Glynn and Ye \cite{wang2010likelihood} and by Hu and Hong \cite{hukullback} provide similar studies using a specific $\phi$-divergence that is described in Section \ref{sec:phi_divergences}.
...
Sections \ref{sec:properties} and \ref{sec:robust_level} describes basic properties of \plp and discusses how to select the level of robustness;
...
and Section \ref{sec:epiconvergence} discusses the asymptotic properties of \plp.
