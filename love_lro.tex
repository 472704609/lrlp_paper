...
Appendix \ref{app:model} contains all additional information on forming the water distribution model.
Appendix \ref{app:results} has the figures demonstrating the results.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \subsection{Decomposition-Based Solution Method} \label{sec:soln_algorithm}
% 
...
% \end{algorithmic}
% 
% \subsubsection{Computational Enhancements}
% 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Results}
% \subsection{The Value of Data} \label{sec:value}
% 
...
\section{Water Distribution Model of Tucson}
\label{app:model}
...
\begin{figure}[!ht]
	...
	\caption{
		Worst-case distribution for the likelihood robust water allocation problem.
	}
