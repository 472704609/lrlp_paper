...
%As is shown in \citep{bental2011robust}, 
...
\[
U_\omega(\x,\mu,\lambda) = \min_{y^\omega \geq 0, z \geq 0} \left\{ z\ \colon\ 
	z + \bar{s}\lambda + \mu - k^\omega y^\omega \geq 0,\  D^\omega y^\omega = d^\omega + B^\omega x \right\},
\]
%\begin{align*}
