...
See Theorem 1 of \cite{bental2011robust} for a derivation of the dual problem, and a proof of Property \ref{property:primal_dual_relation}.
...
The appearance of the conjugate $\phi^*(s)$ in the objective of (\ref{eq:plp_two_stage}) gives a method retrieving the worst-case distribution from the dual problem, as detailed in Property \ref{property:primal_dual_relation}.  
