...
Our results show that the additional treatment plant would result in cost savings over its purchase price within the 40-year time window of the model.
...
We have% also provided a Bender's decomposition-based solution algorithm for the LRLP-2 and 
