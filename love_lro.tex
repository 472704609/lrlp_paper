...
\citeN{erdogan2006ambiguous} studied chance-constrained stochastic programs where the set of distributions considered is determined by the Prohorov metric.
\citeN{calafiore2005uncertain} developed a data-driven method for generating feasible solutions to chance constrained problems, and later \citeN{calafiore2006distributionally} developed a method for converting distributionally robust chance constraints into second-order cone constraints.
\citeN{jiang2012data} developed an exact approach to solving data-driven chance constrained programs.
...
Most of these have already been noted in \citeN{wang2010likelihood} and \shortciteN{bental2011robust}, but we list them for completeness and some of these properties help with our special solution method.
...
For details on its derivation, see \citeN{love2013likelihood}.
